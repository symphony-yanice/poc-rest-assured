        ...
        post {
            always {
                script {
                    ...
                    def patterns = "allure.results.directory=allure-results"
                    patterns += "\nallure.link.issue.pattern=https://perzoinc.atlassian.net/browse/\{\}"
                    patterns += "\nallure.link.tms.pattern=https://perzoinc.atlassian.net/browse/\{\}"
